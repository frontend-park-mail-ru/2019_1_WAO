...
import {BoardComponent} from '../../components/Signin/signin.js';
...
export function renderLoginPage(AjaxModule) {
  ...
  const loginWindowDivTitle = document.createElement('div');
  loginWindowDivTitle.classList.add('login_window_div_title');

  const loginWindowTitle = document.createElement('div');
  loginWindowTitle.classList.add('login_window_title');
  loginWindowTitle.textContent = 'Войти';
  const loginWindowTitlePic = document.createElement('div');
  loginWindowTitlePic.classList.add('login_window_title_pic');
  const svg1 = '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M6.586 8L4.293 5.707a.999.999 0 1 1 1.414-1.414L8 6.586l2.293-2.293a1 1 0 0 1 1.414 1.414L9.414 8l2.293 2.293a1 1 0 0 1-1.414 1.414L8 9.414l-2.293 2.293a1 1 0 0 1-1.414-1.414L6.586 8z"/></svg>';
  ...
  const loginWindowForm = document.createElement('div');
  loginWindowForm.classList.add('login_window_form');
  const form = document.createElement('form');
  form.action = '#'; form.method = 'POST';
  loginWindowForm.appendChild(form);

  const loginWindowDivInForm = document.createElement('div');
  loginWindowDivInForm.classList.add('login_window_div_in_form');

  const inputDivLogin = document.createElement('div');
  inputDivLogin.classList.add('input_div_login');
  const loginWindowPhone = document.createElement('input');
  ...
  const forgotPassCheckboxText = document.createElement('div');
  ...
  const signInContinue = document.createElement('div');
  signInContinue.classList.add('sign_in_continue');
  signInContinue.textContent = 'или продолжить через';
  const signInWithSoc = document.createElement('div');
  ...
  const signInBottom = document.createElement('div');
